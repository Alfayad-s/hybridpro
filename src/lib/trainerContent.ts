/** Polished trainer copy for Hybrid Pro (Akash). */

export const trainer = {
  name: "Akash",
  role: "Founder & CEO · Hybrid Pro Training Program",
  credentials: "Active IQ Level 3 · REPs UAE",
  ...
  approachFocus: [
    ...
    "Intelligent muscle development with purpose behind every session",
  ...
  experienceLead:
    "I’ve partnered with people from every walk of life, including:",
  experienceClients: [
    "Beginners taking their first confident steps into training",
    "Busy professionals who need smart, efficient sessions",
    "Fat-loss clients ready for change that actually lasts",
    "Lifters focused on building serious muscle",
    "Postpartum mothers rebuilding strength safely and steadily",
    "Anyone leveling up strength, mobility, and overall fitness",
    "Online and in-person clients who want real accountability",
  ],
} as const;
